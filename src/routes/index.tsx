    ...
    <div className="bg-cream min-h-screen">
      ...
      <section className="max-w-[1400px] mx-auto px-3 md:px-5 pt-6">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
          {OCCASIONS.map((o) => {
            const Icon = OCCASION_ICONS[o.value] ?? Gift;
            return (
              <Link
                key={o.value}
                to="/search"
                search={{ q: "", occasion: o.value } as any}
              ...
              >
                <Icon className="w-5 h-5 text-maroon group-hover:scale-110 transition-transform" strokeWidth={1.75} />
